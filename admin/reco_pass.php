...
<body>
<section class="login">
	<div class="titulo"><h1>Recover Password</h1>
			<?php
		  if ($_SERVER['REQUEST_METHOD'] == "POST"){
             ...
             elseif(!filter_var($email,FILTER_VALIDATE_EMAIL)){
                ...
                $checkmail = "SELECT * FROM tbl_admin WHERE email ='$email' LIMIT 1";
                 ...
                 if ($result == true) {
                  ...
                  while($value = $result->fetch_assoc()){
		            ...
		            $to    = "$email";
		            $from  = "doinik-sunamkontho@gmail.com";
		            $headers = "From: $from\n";
		        ...
		        $headers .= 'Content-type: text/html; charset=iso-8859-1'."\r\n";
		            ...
		            if ($sendmail) {
		            	echo "<span style='color:green; font-size:20px;'> Check your email for login</span>";
		            }else{
	...
	<form action="#" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <div class="olvido">
        	<input type="submit" class="enviar" value="Submit" style="margin-bottom: 5px; line-height: 50%;">
        </div>
       
         <a href="admin_login.php" class="enviar">Login</a>
    </form>
</section>	
