<?php include('include/header.php'); ?>
   ...
   <?php include('include/sidebar.php'); ?>  
        ...
        <section class="content">
         ...
         <div class="col-md-12">
            ...
            <?php 
              ...
              $del_query = "DELETE FROM page_post WHERE id='$id'";
     ...
     <?php 
     $query = "select page_post.*,tbl_page.name
               from page_post
               inner join tbl_page
               on page_post.category_id = tbl_page.category_id
               order by page_post.id desc limit 10";
     ...
     ?>
      <tbody>
        <tr>
          ...
          <td><a href="editpage_news.php?page_news_id=<?php echo $data['id'];?>" class="btn btn-info">Edit</a> 
    <?php 
