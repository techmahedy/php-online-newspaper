    ...
    <?php
     ...
     ?>
         <div class="single_page">   
              <?php 
              $query  = "select * from page_post where id = '$post_id'";
       ...
       <div class="related_post">           
              <h2>এই সম্পর্কিত আরো পোস্ট <i class="fa fa-thumbs-o-up"></i></h2>
               <?php
                    ...
                    $query       = "select * from page_post where category_id = '$category_id' limit 3";
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="openpage_post?post_id=<?php echo $data['id'];?>"> <img src="admin/<?php echo $data['image'];?>" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="openpage_post?post_id=<?php echo $data['id'];?>"><?php echo $data['title'];?></a> </div>
                  </div>
                </li>    
              </ul>
